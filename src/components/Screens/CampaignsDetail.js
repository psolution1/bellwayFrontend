                                    ...
                                    <nav>
                                        <div className="nav-tabs-head">
                                            <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                                <button className="nav-link active" id="nav-tab-0" data-bs-toggle="tab" data-bs-target="#tab-0" type="button" role="tab" aria-controls="nav-home" aria-selected="true">HOME</button>
                                                <button className="nav-link" id="nav-tab-1" data-bs-toggle="tab" data-bs-target="#tab-1" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">PROSPECTS</button>
                                                <button className="nav-link" id="nav-tab-2" data-bs-toggle="tab" data-bs-target="#tab-2" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">MEMBERS</button>
                                            </div>
                                        </div>
                                    </nav>
                                                        ...
                                                        <div className="col-12 col-xl-12">
                                                            <div className="row">
                                                                <div className="col-12 col-xl-12 text-center pt-3">
                                                                    <span class="MuiButton-label">&nbsp;<b>0</b> &nbsp; overdue out of &nbsp; <b>0</b> &nbsp; pending followups today</span>
                                                                </div>
                                                            </div>
                                                            <div className="row">
